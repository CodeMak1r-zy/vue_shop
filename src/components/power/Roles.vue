        ...
        <!-- 对话框内容:表单验证 -->
          <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="80px">
            ...
            <el-form-item label="角色描述" prop="roleDesc">
              <el-input v-model.trim="editForm.roleDesc"
              @keyup.enter.native="editUserInfo"></el-input>
            </el-form-item>
          </el-form>
          <!-- 对话框底部按钮区域 -->
...
export default {
    ...
    methods: {
        ...
        async removeUserById(id) {
            // 弹窗询问角色是否确定删除
            const confirmResult = await this.$confirm('This operation will permanently delete the role. Do you want to continue?', 'Warning', {
